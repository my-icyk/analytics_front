...
export function RoleDetailPage({
  ...
  useEffect(() => {
    ...
    setSelectedPermissionId((current) =>
      current !== null &&
      matchingPermissions.some((permission) => permission.id === current)
        ? current
        : matchingPermissions[0].id,
    );
  }, [matchingPermissions]);
    ...
    <section className="detail-page">
      ...
      <div className="detail-grid">
        <div className="detail-card">
          ...
          <p>Role metadata can be updated without changing its assignments.</p>
        </div>
        <div className="detail-card">
          <span className="stat-label">Assigned permissions</span>
          <strong>{assignedPermissions.length}</strong>
          <p>
            {assignedPermissions
      ...
      <div className="detail-section">
        <div className="section-heading">
          <div>
            <h3>Permissions</h3>
            <p>Search, add, and remove permissions for this role.</p>
          </div>
        </div>
        {canAssign ? (
          <div className="assignment-picker">
            ...
            <div className="assignment-actions">
              <select
                ...
                disabled={!matchingPermissions.length}
              >
                <option value="">
        ...
        <div className="selected-assignment-list">
          {assignedPermissions.length ? (
            assignedPermissions.map((permission) => (
              <div key={permission.id} className="selected-assignment-item">
                <span>
